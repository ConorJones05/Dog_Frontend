...
const AdminPage = ()=>{
    ...
    const [editingDog, setEditingDog] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchDogs = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:5000/admin/dashboard', {
                headers: {
            ...
            if (err.response && err.response.status === 403) {
                ...
                if (refreshToken) {
                    try {
                        const refreshResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5000/refresh', {
    ...
    const handleAddDog = async (e)=>{
        ...
        try {
            const token = getToken();
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5000/admin', newDog, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleUpdateDog = async (e)=>{
        ...
        try {
            const token = getToken();
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('http://localhost:5000/admin', editingDog, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const fetchStatistics = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:5000/admin/statistics', {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleDeleteDog = async (id)=>{
        ...
        try {
            const token = getToken();
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete('http://localhost:5000/admin', {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                data: {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            editingDog && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
...
_s(AdminPage, "e826TKg3tFiqteURcgMwjHkDqGs=", false, function() {
    return [
